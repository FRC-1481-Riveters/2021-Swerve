...
public class RobotMap {
    public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_MOTOR = 11; // CAN
    public static final int DRIVETRAIN_FRONT_LEFT_ANGLE_ENCODER = 0; // Analog
    public static final int DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR = 10; // CAN
    ...
    public static final int DRIVETRAIN_FRONT_RIGHT_DRIVE_MOTOR = 12; // CAN
    ...
    public static final int DRIVETRAIN_BACK_RIGHT_ANGLE_MOTOR = 17; // CAN
    public static final int DRIVETRAIN_BACK_RIGHT_ANGLE_ENCODER = 3; // Analog
    public static final int DRIVETRAIN_BACK_RIGHT_DRIVE_MOTOR = 16; // CAN
}
